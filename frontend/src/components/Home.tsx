		...
		<div>
			...
			<div className="flex w-full h-screen bg-neutral-300">
				<div className="relative w-1/2 h-full">
					<div className="absolute h-1/2 w-1/2 right-0 m-10 bg-black/80 rounded-xl">1</div>
					<div className="absolute h-1/2 w-1/2 bottom-0 left-1/4 mb-24 bg-black/40 rounded-xl">2</div>
					<div className="absolute h-1/2 w-1/2 m-20 mt-24 ml-10 bg-black/60 rounded-xl">3</div>
				</div>
				<div className="flex w-1/2 h-full items-center jusity-center px-20">
					<div>
						...
						<p className="mb-10 text-sm text-dark-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim reprehenderit recusandae accusamus libero repellat architecto aspernatur possimus quae tempore at fugiat non nam illum quod deserunt magnam, quas laborum incidunt?</p>
					</div>
				</div>
			</div>
